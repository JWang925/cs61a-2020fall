...
def count_coins(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def count_partitions(n, m): ##count how to make n with up-to m parts
        if n == 0:
            return 1
        elif n < 0:
            return 0
...
def make_anonymous_factorial():
    ...
    True
    """
    ## <facotiral> = (lambda b, f: 1 if b == 1 else f(f, b-1)*b)
    return  (lambda b: (lambda b, f: f(b, f))   (b, lambda b, f: 1 if b == 1 else f(b-1, f)*b)) 
